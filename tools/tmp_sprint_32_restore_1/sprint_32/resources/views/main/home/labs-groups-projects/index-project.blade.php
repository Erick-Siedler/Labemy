...
<div class="container-info project-dashboard">
    ...
    <div class="owner-shell">
        <div class="owner-tabs" role="tablist" aria-label="Seções do projeto">
            <button type="button" class="owner-tab" data-owner-tab="dashboard" role="tab" aria-selected="false" aria-controls="project-panel-dashboard">dashboard</button>
            <button type="button" class="owner-tab is-active" data-owner-tab="versions" role="tab" aria-selected="true" aria-controls="project-panel-versions">Versões</button>
        </div>

        <div class="owner-panel">
            <section class="owner-panel-section" id="project-panel-dashboard" data-owner-panel="dashboard" role="tabpanel" hidden>
                ...
                <div class="graph-grid" data-animate>
                    <div class="graph-card">
                        <div class="graph-header">
                            <div>
                                ...
                                <p class="graph-sub">Últimos 6 meses (MB)</p>
                            </div>
                        </div>
                        <div class="graph-body">
                            <div class="chart-wrap chart-bar">
                                <canvas id="projectStorageChart" class="chart-canvas" data-series='@json($storageTrend)'></canvas>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="graph-card">
                        <div class="graph-header">
                            <div>
                                <h3>Novas Versões</h3>
                                <p class="graph-sub">Últimos 6 meses</p>
                            </div>
                        </div>
                        <div class="graph-body">
                            <div class="chart-wrap chart-bar">
                                <canvas id="projectVersionsChart" class="chart-canvas" data-series='@json($versionsTrend)'></canvas>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="owner-panel-section" id="project-panel-versions" data-owner-panel="versions" role="tabpanel">
