...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'O campo :attribute informado apareceu em vazamentos de dados. Escolha outro.',
    ],
    'present' => 'O campo :attribute deve estar presente.',
    'prohibited' => 'O campo :attribute é proibido.',
    'prohibited_if' => 'O campo :attribute é proibido quando :other for :value.',
    'prohibited_unless' => 'O campo :attribute é proibido a menos que :other esteja em :values.',
    'prohibits' => 'O campo :attribute proíbe :other.',
    ...
    'attributes' => [
        ...
        'version_file' => 'arquivo da versão',
        'status' => 'status',
        'role' => 'função',
        'max_labs' => 'máximo de laboratórios',
        'max_users' => 'máximo de usuários',
        'max_storage_mb' => 'armazenamento máximo',
        'max_projects' => 'máximo de projetos',
        'settings' => 'configurações',
        'settings.max_labs' => 'máximo de laboratórios',
        'settings.max_users' => 'máximo de usuários',
        'settings.max_storage_mb' => 'armazenamento máximo',
        'settings.max_projects' => 'máximo de projetos',
        'settings.theme' => 'tema',
        'settings.language' => 'idioma',
        'settings.timezone' => 'fuso horário',
        'settings.compact' => 'modo compacto',
        'notifications.email' => 'notificações por e-mail',
        'notifications.calendar' => 'notificações de calendário',
        'notifications.projects' => 'notificações de projetos',
        'cpf' => 'CPF/CNPJ',
        'slug' => 'identificador',
